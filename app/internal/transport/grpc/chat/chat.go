...
func (s *ServerAPI) IdentUser(ctx context.Context, req *chatGrpc.IdentUserRequest) (*chatGrpc.IdentUserResponse, error) {
	...
	return &chatGrpc.IdentUserResponse{
		UserId:    user.Id,
...
func validateIdentUser(req *chatGrpc.IdentUserRequest) error {
